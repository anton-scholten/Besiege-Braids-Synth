...
namespace BraidsSynth
{
    ...
    //
    // Taken as-is from Special Effects, by the same author, where it was written for
    // the same reason and works. Keep it in step with that copy rather than letting
    // the two drift.
    //
    ...
    public class Chooser : MonoBehaviour
    {
        ...
        {
            return Make(host, root, x, y, w, h, choices, picked, true);
        }
        ...
        private static Text Word(GameObject on, string text, TextAnchor align)
        {
